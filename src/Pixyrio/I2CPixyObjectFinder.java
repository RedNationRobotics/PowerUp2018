...
public class I2CPixyObjectFinder {
    ...
    PixyException pExc;
    String print;
    public I2CPixyObjectFinder (String id, I2C argPixy, PixyPacket[] argPixyPacket, PixyException argPixyException,
    ...
    public PixyPacket readPacket(int _Signature) throws PixyException {
        ...
        try {
            ...
            SmartDashboard.putString(name + "Status", e.toString()); //put this in a thread or just a print
            System.out.println(name + "  " + e);
        }
        if (rawData.length < 32) {
            SmartDashboard.putString(name + "Status", "raw data length " + rawData.length); // same for this ^
